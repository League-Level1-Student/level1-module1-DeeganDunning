...
@Override
   ...
   */
  player1 = new Player(30, 400, 5, 50, #ff0000, W, A, S, D);
  player2 = new Player(570, 400, 5, 50, #0000ff, UP, LEFT, DOWN, RIGHT);
}
...
public void displayStats() {
  ...
  String player1Display = "Player 1 Coverage: " + String.format("%.2f", calculateRoundedPixelPercentage(player1.pixelCount)) + "%";
  text(player1Display, (width/2 - (player1Display.length()*statsBoardSpacing) / 4), statsBoardSpacing*2);

  String player2Display = "Player 2 Coverage: " + String.format("%.2f", calculateRoundedPixelPercentage(player2.pixelCount))  + "%";
